        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-800 mt-2">
              <strong>To collaborate with your team:</strong> Ensure everyone is working within the same ValidateHub instance or by sharing exported data (if export features are added in the future).
            </p>
            <p className="text-sm text-gray-800 mt-2">
              <strong>To share with mentors/advisors:</strong> You can walk them through your ValidateHub dashboards and canvases during meetings, or share specific insights you've documented.
            </p>
          </div>
        </div>
      </Card>
      ...
      <Card title="Future Collaboration Enhancements">
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-800">
              (Coming Soon) Integrated tools for visual brainstorming, enabling remote teams to generate and organize ideas collaboratively within ValidateHub.
            </p>
          </div>
          <div>
